        ...
        <div id="tour-overlay-active" className="fixed inset-0 z-[100] pointer-events-none fade-in">
            ...
            {targetRect && (
                ...
                >
                    ...
                    <div className="text-white/70 text-sm leading-relaxed mb-6 font-medium">
                        {state.currentStep.id === 'step-movement' ? (
                            <>
                                Drag to rotate and pan the camera. Use your
                                <span className="inline-flex items-center gap-1 mx-1.5 px-1.5 py-0.5 bg-white/10 rounded-md border border-white/20 select-none">
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#ccff00]"><path d="m18 15-6-6-6 6" /></svg>
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#ccff00]"><path d="m6 9 6 6 6-6" /></svg>
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#ccff00]"><path d="m15 18 6-6-6-6" /></svg>
                                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#ccff00]"><path d="m9 18-6-6 6-6" /></svg>
                                    <span>Arrow Keys</span>
                                </span>
                                (desktop) or
                                <span className="inline-flex items-center gap-1 mx-1.5 px-1.5 py-0.5 bg-white/10 rounded-md border border-white/20 select-none">
                                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#ccff00]"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="3" fill="currentColor" /></svg>
                                    <span>Joystick</span>
                                </span>
                                (mobile) to walk around the environment.
                            </>
                        ) : (
                            <p>{description}</p>
                        )}
